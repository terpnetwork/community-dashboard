          ...
          <ModalBody>
            ...
            <Stack direction="column" spacing={4}>
              ...
              <StatBox
                ...
                token={delegationCoin.symbol}
              />
              {renderUndelegateInputBox('Amount to Undelegate', delegationCoin.symbol)}
            </Stack>
          </ModalBody>
                  ...
                  {allValidator.map((validator: Validator, index: number) => (
                    ...
                    >
                      ...
                      <Td>
                        ...
                        &nbsp;
                        <Token color="blackAlpha.800" token={delegationCoin.symbol} />
                      </Td>
                      <Td>
      ...
      >
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            {renderRedelegateInputBox('Amount to Redelegate', delegationCoin.symbol)}
          </ModalBody>
              ...
              <Tr key={validator.name}>
                ...
                <Td>
                  <Box width="100%" display="flex" alignItems="center">
                    <span>
                      {validator.reward}&nbsp;
                      <Token color="blackAlpha.800" token={feeCoin.symbol} />
                    </span>
                    <Button
                      variant="ghost"
                      ml="auto"
