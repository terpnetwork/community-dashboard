...
import { getFeeCoin, getDelegationCoin } from '../../config';
    ...
    <StatGroup>
      <Stat py={2} minWidth="200px">
        <StatLabel
          ...
          fontSize="md"
        >
          Total {delegationCoin.symbol} Amount
        </StatLabel>
        <StatNumber>
          {totalAmount === 0 ? totalAmount : totalAmount.toFixed(6)}&nbsp;
          <Token token={delegationCoin.symbol} />
        </StatNumber>
      </Stat>
      ...
      <Stat py={2} minWidth="200px">
        ...
        <StatNumber>
          {balance} <Token token={delegationCoin.symbol} />
        </StatNumber>
      </Stat>
