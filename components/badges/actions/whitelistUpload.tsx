...
export const WhitelistUpload = ({ onChange }: WhitelistUploadProps) => {
      ...
      names.map(async (name) => {
        ...
        await (
          ...
          .then((res) => {
            ...
            else toast.error(`Resolved address is empty or invalid for the name: ${name}.terp`)
          })
          .catch((e) => {
            console.log(e)
  ...
  const onFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = async (e: ProgressEvent<FileReader>) => {
      ...
      const names = printableData?.filter((address) => address !== '' && address.endsWith('.terp'))
      ...
      return onChange([
        ...new Set(
          printableData
            ?.filter((address) => address !== '' && isValidAddress(address) && address.startsWith('terp'))
