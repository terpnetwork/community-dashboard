...
import { SingleAssetPreview } from '../utils/singleAssetPreview'
import { UploadServiceType } from '../services/upload'
        ...
        <Conditional test={uploadMethod === 'existing'}>
          <div className="ml-3 flex-column">
            <p className="mb-5 ml-5">
              ...
              <Link className="font-bold text-plumbus hover:underline" href="https://nft.storage">
                NFT.Storage
              </Link>{' '}
              or{' '}
              <Link className="font-bold text-plumbus hover:underline" href="https://www.pinata.cloud/">
                Pinata
              </Link>{' '}
