...
import { MintRule, UploadMethod } from './imageUploadDetails'
          ...
          <div className="grid grid-cols-2">
            ...
            <Conditional test={managerState.value !== ''}>
              <Tooltip
                ...
                title="This is only an estimate. Be sure to check the final amount before signing the transaction."
                placement="bottom"
              >
                <div className="grid grid-cols-2 ml-12 w-full">
                  <div className="mt-4 font-bold">Fee Estimate:</div>
                  <span className="mt-4">{(metadataSize * Number(metadataFeeRate)) / 1000000} terp</span>
                </div>
              </Tooltip>
            </Conditional>
          </div>
        ...
        <div className={clsx('ml-10')}>
          ...
          <div className="w-full">
            <Tooltip
              ...
              title="A metadata file can be selected to automatically fill in the related fields."
              placement="bottom"
            >
              <div>
                <label
