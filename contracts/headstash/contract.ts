...
export interface HeadstashAirdropInstance {
  readonly contractAddress: string
...
export interface HeadstashAirdropMessages {
...
export interface HeadstashAirdropContract {
  instantiate: (
  ...
  use: (contractAddress: string) => HeadstashAirdropInstance

  messages: () => HeadstashAirdropMessages
}

export const HeadstashAirdrop = (client: SigningCosmWasmClient, txSigner: string): HeadstashAirdropContract => {
  const use = (contractAddress: string): HeadstashAirdropInstance => {
        ...
        [
          {
            ...
            value: {
              ...
              amount: [
                coin(amount, config.bondToken),
                coin(amount, config.feeToken),
              ],
            },
          },
        ],
  ...
  const messages = () => {
    ...
    // const depositEscrow = (headstashAddress: string): DepositEscrowMessage => {
    //   return {
    //     sender: txSigner,
    //     contract: ESCROW_CONTRACT_ADDRESS,
    //     msg: {
    ...
    const withdrawAll = (headstashAddress: string, address: string, amount?: number): WithdrawAllMessage => {
      return {
        sender: txSigner,
        contract: headstashAddress,
        msg: {
